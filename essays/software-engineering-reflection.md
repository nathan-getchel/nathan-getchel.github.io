...
<img style="display: block; margin-left: auto; margin-right: auto; width: 70%" width="500px" class="rounded float-start pe-4" src="../img/missile.png">
...
<img width="600px" class="rounded float-start pe-4" src="../img/linux_penguins.png">
